...
// type Context[User any] interface {
// 	echo.Context
...
// func NewTestContext(c echo.Context) *context[any] {
// 	c.Get("xx")
// 	return &context[any]{c, nil, nil}
// }

// func (c *context[User]) SetUser(u User) {
// 	c.user = u

// 	// 增加新的日志字段
// 	// c.logger = c.logger.WithField("user", u).WithField("userid", u.UserId)
// }
