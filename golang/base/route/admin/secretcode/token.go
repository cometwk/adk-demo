...
import (
	...
	"github.com/lucky-byte/base/lib/ticket"
	"github.com/lucky-byte/base/pkg/secure"
	"github.com/pkg/errors"
	"github.com/sirupsen/logrus"
)

var xlog = logrus.WithField("module", "secretcode")
...
func genToken(user_uuid string) string {
	...
	if r, err := secure.RandomBytes(16); err != nil {
		xlog.WithError(err).Error("生成安全随机数错")
	...
	if err != nil {
		xlog.WithError(err).Errorf("保存安全码 token 错")
	}
	return token
}
