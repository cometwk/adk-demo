...
// 短信服务
type SMS struct {
	UUID      string    `json:"uuid"       xorm:"'uuid' varchar(36) pk notnull comment('UUID')"`
	CreateAt  time.Time `json:"create_at"  xorm:"created 'create_at' notnull comment('创建时间')"`
	UpdateAt  time.Time `json:"update_at"  xorm:"updated 'update_at' notnull comment('更新时间')"`
	ISP       string    `json:"isp"        xorm:"'isp' varchar(16) notnull comment('运营商')"`
	ISPName   string    `json:"isp_name"   xorm:"'isp_name' varchar(64) notnull comment('运营商名称')"`
	AppId     string    `json:"appid"      xorm:"'appid' varchar(32) notnull default '' comment('应用ID')"`
	SecretId  string    `json:"secret_id"  xorm:"'secret_id' varchar(64) notnull default '' comment('密钥ID')"`
	SecretKey string    `json:"secret_key" xorm:"'secret_key' varchar(64) notnull default '' comment('密钥Key')"`
	Prefix    string    `json:"prefix"     xorm:"'prefix' varchar(32) notnull default '' comment('签名')"`
	TextNo1   string    `json:"textno1"    xorm:"'textno1' varchar(32) notnull default '' comment('验证码模板')"`
	TextNo2   string    `json:"textno2"    xorm:"'textno2' varchar(32) notnull default '' comment('模版2')"`
	TextNo3   string    `json:"textno3"    xorm:"'textno3' varchar(32) notnull default '' comment('模版3')"`
	TextNo4   string    `json:"textno4"    xorm:"'textno4' varchar(32) notnull default '' comment('模版4')"`
	SortNo    int       `json:"sortno"     xorm:"'sortno' int unique comment('排序序号')"`
	NSent     int       `json:"nsent"      xorm:"'nsent' int default 0 comment('发送量')"`
	Disabled  bool      `json:"disabled"   xorm:"'disabled' boolean default false comment('是否停用')"`
}
