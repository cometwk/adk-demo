import type { PropertyFilter } from './graph-query'

// ── Filter Evaluation ──
// Evaluates property filters against a properties object
...
export function projectFields(props: Record<string, unknown>, fields?: string[]): Record<string, unknown> {
